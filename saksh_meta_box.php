...
function saksh_add_room_type_taxonomies() {
  ...
  register_taxonomy('room_type', 'rooms', array(
    ...
    'labels' => array(
      'name' => _x( 'Room type'  ,'saksh-wp-hotel-booking-lite'),
      'singular_name' => _x( 'Room type'  ,'saksh-wp-hotel-booking-lite'),
...
function saksh_add_amenity_taxonomies() {
  ...
  register_taxonomy('amenities', 'rooms', array(
    ...
    'labels' => array(
      'name' => _x( 'Amenities','saksh-wp-hotel-booking-lite'  ),
      'singular_name' => _x( 'Amenity','saksh-wp-hotel-booking-lite'  ),
...
function saksh_meta_box_callback_rate_per_night($post)
{
 ...
 $product_id=  saksh_hotel_booking_product() ; 
...
//echo "</pre>";
 ?>
    ...
    <div id="tabs">
  <ul>
    <li><a href="#tabs-1"><?php _e('Booking option 1', 'saksh-wp-hotel-booking-lite'); ?>  </a></li>
    
    <li><a href="#tabs-2"><?php _e('Booking option 2', 'saksh-wp-hotel-booking-lite'); ?>  </a></li>
     
    
    <li><a href="#tabs-3"><?php _e('Booking option 3', 'saksh-wp-hotel-booking-lite'); ?>  </a></li>
    
    <li><a href="#tabs-4"><?php _e('Booking option 4', 'saksh-wp-hotel-booking-lite'); ?>  </a></li>
    
    <li><a href="#tabs-5"><?php _e('Booking option 5', 'saksh-wp-hotel-booking-lite'); ?>  </a></li>
...
function saksh_meta_box()
{
  ...
  add_meta_box(
            'short_intro',
            __('Short intro', 'saksh-wp-hotel-booking-lite'),
            ...
            __('Booking data', 'saksh-wp-hotel-booking-lite'),
  ...
  add_meta_box(
            'other_details',
            __('Other details', 'saksh-wp-hotel-booking-lite'),
